...
const poolData = {
    UserPoolId: "us-west-2_pdglrtFDj",
    ClientId: "3j1k36akb78jgvom3vb525tu3a",
};
...
const validate = (req, res, next) => {
    ...
    request({
        url : `https://cognito-idp.us-west-2.amazonaws.com/us-west-2_pdglrtFDj/.well-known/jwks.json`,
        json : true
    }, (error, response, body) => {
        let pem;
